...
<div class="row">
	<div class="col-md-2">
		<div class="groupcontainer">
			Thể loại
			<div class="groupitem">
			<div><a href='#' class="group">Đã giao hàng</a></div>
			<div><a href='#' class="group">Đã thanh toán</a></div>
			<div><a href='#' class="group">Chờ xử lý</a></div>
			<div><a href='#' class="group">Hủy</a></div>
			</div>
		</div>
	</div>
	<div class="col-md-10 ">
